...
decisions: [D-002, D-010, D-013, D-017, D-022, D-023, D-043, D-056, D-057, D-062, D-063, D-064, D-065, D-066]
---
...
- `/statistik` (+ `/en/stats`) — the founders' stats dashboard (D-063; the Strom funnel of D-066 as its centrepiece): `noindex`, excluded
